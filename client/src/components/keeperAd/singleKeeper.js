...
import ModalUpdateAd from "./modalUpdateKeeperAd";
import styleDonationads from "../../styles/SingleDonationAds.module.css"
import styleKeeperAds from "../../styles/DonationAds.module.css"
import loading from "../../assets/loading.gif"



const SingleKeeper = (props) => {
    ...
    let { id } = useParams();
    const [keeperad, setKeeper] = useState({});
                ...
                <div className={styleDonationads.containerSingle}>
                    ...
                    <div className={styleDonationads.subContainerSingle}>
                        ...
                        <div className={styleDonationads.detailsSingle}>
                            ...
                            <div className={styleKeeperAds.dateCard}>
                                <div className={styleDonationads.containerDateSingle}>
                                    <span className={styleKeeperAds.wordItemCard}>Start</span> <p> {keeperad.start}</p>
                                </div>
                                <div className={styleDonationads.containerDateSingle}>
                                    <span className={styleKeeperAds.wordItemCard}>End</span> <p>{keeperad.end}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    {props.user ?
                        <div>
                            {userId === props.user.user.id ?
                                <div className={styleDonationads.IconsEditDeleteKeeper}>
                                    ...
                                    <ModalUpdateAd isShowing={isUpdateFormShowed} hide={toggleUpdateForm} keeperad={keeperad} setKeeper={setKeeper} setImg={setImg} arrayBufferToBase64={arrayBufferToBase64} />
                                </div>
                                :
                                null}
                        </div>
